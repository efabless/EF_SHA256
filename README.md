...
The following table is the result for implementing the EF_SHA256 IP with different wrappers using Sky130 PDK and [OpenLane2](https://github.com/efabless/openlane2) flow.
...
## Firmware Drivers:
Firmware drivers for EF_SHA256 can be found in the [fw](https://github.com/efabless/EF_SHA256/tree/main/fw) directory. EF_SHA256 driver documentation  is available [here](https://github.com/efabless/EF_SHA256/blob/main/fw/README.md).
You can also find an example C application using the EF_SHA256 drivers [here]().
## Installation:
