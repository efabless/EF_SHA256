...
Hardware implementation of the SHA-256 cryptographic hash function. The rtl is based on [this repo](https://github.com/secworks/sha256) 
...
The following table is the result for implementing the SW_SHA256 IP with different wrappers using Sky130 PDK and [OpenLane2](https://github.com/efabless/openlane2) flow.
...
### The Interface 
<img src="docs/sha256_core.svg" width="600"/>
