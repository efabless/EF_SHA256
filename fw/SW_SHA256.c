...
void SW_SHA256_writeBlock(uint32_t sha256_base, int *block, bool isFirst){
    ...
    SW_SHA256_TYPE* sha256 = (SW_SHA256_TYPE*)sha256_base;
    if (isFirst){
...
void SW_SHA256_waitReady(uint32_t sha256_base){
    ...
    while(!SW_SHA256_ready(sha256_base));
}
...
void SW_SHA256_waitResultValid(uint32_t sha256_base){
    ...
    while(!SW_SHA256_resultValid(sha256_base));
}
...
void SW_SHA256_writeMode(uint32_t sha256_base, bool is265){
    ...
    int control = SW_SHA256_readControl(sha256_base);
    if (is265 == true)
        control |= 0x4;
    else
        control &= ~(0x4);
    SW_SHA256_writeControl(sha256_base, control);
}
...
void SW_SHA256_sendBlockFirst(uint32_t sha256_base, int *blocks0,int *blocks1, bool is265){
    ...
    SW_SHA256_writeMode(sha256_base, is265);
    SW_SHA256_writeBlock(sha256_base, blocks1, 1);
    SW_SHA256_writeBlock(sha256_base, blocks0, 0);
    SW_SHA256_sendInit(sha256_base);
    SW_SHA256_waitReady(sha256_base);
}
...
void SW_SHA256_sendBlock(uint32_t sha256_base, int *blocks0,int *blocks1){
    ...
    SW_SHA256_writeBlock(sha256_base, blocks1, 1);
    SW_SHA256_writeBlock(sha256_base, blocks0, 0);
    SW_SHA256_sendNext(sha256_base);
    SW_SHA256_waitReady(sha256_base);
}

void SW_SHA256_waitGetResult(uint32_t sha256_base, int *result){
    
    SW_SHA256_waitResultValid(sha256_base);
    SW_SHA256_readDigest(sha256_base, result);
}
